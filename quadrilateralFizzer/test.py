...
def make_randomInt_1_to_100():
    for index in range(1, 351):
        ...
        for index in range(1):
            file.write("{0} {1} {2} {3} {4} {5}".format(str(random.randint(0, 100)), str(random.randint(0, 100)),
...
def make_randomNumber_101_to_sysMaxSize():
    for index in range(1, 351):
        ...
        for index in range(1):
            file.write(
                "{0} {1} {2} {3} {4} {5}".format(str(random.randint(101, sys.maxsize)),
                                                 str(random.randint(101, sys.maxsize)),
                                                 str(random.randint(101, sys.maxsize)),
                                                 str(random.randint(101, sys.maxsize)),
                                                 str(random.randint(101, sys.maxsize)),
                                                 str(random.randint(101, sys.maxsize))))
